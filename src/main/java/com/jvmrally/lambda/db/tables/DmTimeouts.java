...
public class DmTimeouts extends TableImpl<DmTimeoutsRecord> {
     ...
     */
    public final TableField<DmTimeoutsRecord, Long> USERID =
            createField("userid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>dm_timeouts.last_message_time</code>.
     */
    public final TableField<DmTimeoutsRecord, Long> LAST_MESSAGE_TIME =
            createField("last_message_time",
                    org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
                            org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.BIGINT)),
                    this, "");
