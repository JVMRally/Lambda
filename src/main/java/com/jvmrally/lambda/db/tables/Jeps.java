...
public class Jeps extends TableImpl<JepsRecord> {
     ...
     */
    public final TableField<JepsRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>jeps.title</code>.
     */
    public final TableField<JepsRecord, String> TITLE = createField("title", org.jooq.impl.SQLDataType.VARCHAR(100), this, "");

    /**
     * The column <code>jeps.jep_type</code>.
     */
    public final TableField<JepsRecord, String> JEP_TYPE = createField("jep_type", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>jeps.jep_status</code>.
     */
    public final TableField<JepsRecord, String> JEP_STATUS = createField("jep_status", org.jooq.impl.SQLDataType.VARCHAR(30).nullable(false), this, "");

    /**
     * The column <code>jeps.release</code>.
     */
    public final TableField<JepsRecord, String> RELEASE = createField("release", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>jeps.component</code>.
     */
    public final TableField<JepsRecord, String> COMPONENT = createField("component", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>jeps.jep_url</code>.
     */
    public final TableField<JepsRecord, String> JEP_URL = createField("jep_url", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");
